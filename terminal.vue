    ...
    <b-row class="content" style="height: 86vh">
      ...
      <b-col cols="3">
        <div class="div" style="height: 60%; width:100%">
          <b-tabs v-model="activeIndex" content-class="mt-3" @click="changeTab">
            <b-tab title="Simple">
              <b-tabs content-class="mt-3">
                <b-tab title="Limit" active>
                  <b-row>
                    <b-col cols="12">
            ...
            <b-tab title="rsi">
              <b-row>
                <b-col cols="12">
                  <b-card bg-variant="light">
                    <create-rsi-form :market="activeMarket" :exchange="activeExchange"/>
                  </b-card>
                </b-col>
              </b-row>
            </b-tab>
            <b-tab title="macd">
              <b-row>
                <b-col cols="12">
                  <b-card bg-variant="light">
                    <create-macd-form :market="activeMarket" :exchange="activeExchange"/>
                  </b-card>
                </b-col>
              </b-row>
            </b-tab>
            <b-tab title="regroupPRICE">
              <b-row>
                <b-col cols="12">
                  <b-card bg-variant="light">
                    <create-regroupPRICE-form :market="activeMarket" :exchange="activeExchange"/>
                  </b-card>
                </b-col>
              </b-row>
            </b-tab>
